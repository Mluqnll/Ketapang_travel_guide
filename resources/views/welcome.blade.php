    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <div class="logo"> <a href="{{ url('desaWisata') }}"><img class="logo logo-display"
                                src="{{ url('public') }}/assets-web/images/logo-white.png" alt=""> <img
                                class="logo logo-scrolled" src="{{ url('public') }}/assets-web/images/logo-black.png"
                                alt=""> </a> </div>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-center pull-right" data-in="fadeIn" data-out="fadeOut">
                        <li class="dropdown">
                            <a href="#home" class="dropdown-toggle page-scroll" data-toggle="dropdown">Desa Wisata</a>
                        </li>
                        <li><a class="page-scroll" href="{{ url('atraksiWisata') }}">amuniti</a></li>
                        ...
                        <li data-index="rs-3045" data-transition="slotfade-vertical" data-slotamount="default"
                            ...
                            <div class="hero-text-wrap">
                                <div class="tp-caption NotGeneric-Title tp-resizeme" id="slide-3045-layer-1"
                                    ...
                                    data-voffset="['-90','-90','-90','-50']" data-fontsize="['30','30','30','25']"
                                    ...
                                    style="font-family: 'Raleway', sans-serif;font-weight:400;text-transform:uppercase;letter-spacing:5px;">
                                    A POWERFUL TOUR FROM</div>

                                <!-- LAYER NR. 2 -->
                                <div class="tp-caption NotGeneric-Title tp-resizeme" id="slide-3045-layer-2"
                                    data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                    data-y="['middle','middle','middle','middle']"
                                    data-voffset="['-10','-10','-10','-10']" data-fontsize="['80','80','66','30']"
                                    data-lineheight="['96','96','86','40']" data-width="none" data-height="none"
                                    data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                                    ...
                                    data-paddingright="[0,0,0,0]" data-paddingbottom="[10,10,10,10]"
                                    data-paddingleft="[0,0,0,0]"
                                    style="font-family: 'Raleway', sans-serif;font-weight:800;text-transform:uppercase;letter-spacing:10px;">
                                    E-KTG</div>
                                ...
                                <div class="tp-caption NotGeneric-SubTitle tp-resizeme" id="slide-3045-layer-3"
                                    data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                    data-y="['middle','middle','middle','middle']"
                                    data-voffset="['70','70','70','40']" data-fontsize="['16','16','16','16']"
                                    data-lineheight="['20','20','20','20']" data-width="none" data-height="none"
                                    data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                                ...
                                <!-- LAYER NR. 6 -->
                                <div class="tp-caption rev-scroll-btn" id="slide-3238-layer-13"
                                    data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                ...
                <div class="row">
                    <div class="col-md-10 centerize-col text-center wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title">
                            ...
                            <p>
                                ELECTONIC KETAPANG TRAVEL GUIDE, e-KTG (beta), adalah sarana penyedia informasi
                            ...
                            <p>
                                Silahkan KLIK pada poster desa wisata yang tersedia untuk menemukan beragam informasi
        ...
        <section id="blog" class="white-bg">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 blog-list wow fadeInDown" data-wow-delay="0.2s">
                        <div class="post-wrap">
                            <div class="post-img">
                ...
                <span class="month">NOV</span>
                                ...
                                <div class="blog-grid-slider slick">
                                    <div class="item"><a href="#"><img class="img-responsive"
                                                src="{{ url('public') }}/assets-web/images/post/1.jpg"
                                                alt="" /></a></div>
                                    <div class="item"><a href="#"><img class="img-responsive"
                                                src="{{ url('public') }}/assets-web/images/post/2.jpg"
                                                alt="" /></a></div>
                                    <div class="item"><a href="#"><img class="img-responsive"
                                                src="{{ url('public') }}/assets-web/images/post/3.jpg"
                                                alt="" /></a></div>
                                    <div class="item"><a href="#"><img class="img-responsive" src=""
                                                alt="Tidak Dapat Memuat Gambar" /></a></div>
                                </div>
                            </div>
                            <div class="post-text">
                                <h3><a href="#">*Nama Desa Wisata*</a></h3>
                                <p>
                    ...
                    <div class="row wow fadeInUp" data-wow-delay="0.1s">
                        <div class="col-md-8 centerize-col text-center">
                            <div class="footer-logo">
                                <a href="index.html"><img src="{{ url('public') }}/assets-web/images/logo-white.png"
                                        class="img-responsive centerize-col" alt="Footer Logo" /></a>
                            </div>
                            <div class="copy-right">© 2019 <span class="default-color">Sylphy.</span> All rights
                                reserved</div>
