                        ...
                        <div class="auth-form-wrap pt-xl-0 pt-70">
                            <div class="auth-form w-xl-25 w-sm-50 w-100">
                                <a class="d-flex auth-brand align-items-center justify-content-center  mb-45" href="#">
									<img class="brand-img d-inline-block mr-5" src="{{url('public')}}/dist/img/logo.png" alt="brand" /><span class="text-dark font-23">Deepor</span>
								</a>
                                <form>
                                    <h1 class="display-4 mb-10 text-center">404. That's an  error.</h1>
                                    <p class="mb-30 text-center">We are sorry but requested page does not exist. You can <a href="dashboard1.html"><u>return to homepage</u></a> or make search below to find the correct page.</p>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form-control form-control-lg filled-input rounded-input bg-white" placeholder="Search and hit Enter" type="text">
